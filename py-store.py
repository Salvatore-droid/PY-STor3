...
def main():
    ...
    print('''
        ...
        [< .. Name              Application ID             Version            Branch       Installation .. >]     | **NOTE:-After installation, the app is ran automatically by py-store
             WPS Office        com.wps.Office             11.1.0.11719       stable       system                  |        -Use above command to run app in terminal  
